...
T1=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data//MeanT1ForPy.mat')
age=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/AgeForPy.mat')
tracts=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/tractVecForPy.mat')

xReg=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/xRegForPy.mat')
yReg=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/yRegForPy.mat')
tReg=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/tractRegForPy.mat')

yRegLower=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/yLowerRegForPy.mat')
yRegUpper=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/yUpperRegForPy.mat')


df=pd.DataFrame(age['age'])
df.columns=['age']
df.insert(1,"tractIdx",tracts['tractVec'])
df.insert(2,"T1",T1['T1']/1000)
...
tracts=['ATR', 'ATR', 'CS', 'CS', 'CC', 'CC',
        'CH', 'CH', 'FMa', 'FMi','IFOF', 'IFOF',
        'ILF', 'ILF', 'SLF', 'SLF','UCI', 'UCI', 
        'AF', 'AF', 'MLF','MLF', 'VOF', 'VOF', 'pAF', 'pAF']

tractPos = {'CS': (0, 0), 'ATR': (0, 1),'VOF': (0, 6), 'pAF': (0, 7),'FMa': (0,3),'FMi':(0,4),
...
fig.tight_layout
plt.subplots_adjust(left=0.05,bottom=0.01,right=0.99,top=1,wspace=0.1,hspace=0.1)
sns.despine()
...
for hem in hems:
    ...
    for ct in foi:
        ...
        g=ax.fill_between(currentTract['xReg'],currentTract['yRegLower'],currentTract['yRegUpper'],alpha=0.1,color=[0.5, 0.5, 0.5])
        ...
        plt=sns.scatterplot(x="age", y="T1",
        data=currentTract,hue="tractIdx",
        palette=[color_list_chosen[col]],
        ...
        if ct == 2 or ct==3 or ct==22 or ct==23 or ct==8 or ct==18 or ct==19 or ct==14 or ct==15:
            ax.set_ylabel('T1 [s]',fontsize=14)
            ax.set_yticklabels([0,1.5,2,2.5],color=[0,0,0])
...
fig.savefig("/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Output/Fig2a.png",format='png')       