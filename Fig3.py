...
mri0T1=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/mri0T1ForPy.mat')
...
mri3T1=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/mri3T1ForPy.mat')
...
mri6T1=loadmat('/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Data/mri6T1ForPy.mat')
        ...
        for ct in foi:
            ...
            if t=="mean":
                ...
                if ct == 2 or ct==14 or ct==18 or ct==8 or ct==22 :
                    ax.set_ylabel('T1 [s]',fontsize=20)
                    ax.set_yticks([1.5,2.5])
                    ax.set_yticklabels([1.5,2.5],Fontsize=18)
                else:
            ...
            fig.savefig("/biac2/kgs/projects/babybrains/mri/code/babyDWI/CatchUp/Output/Fig3.png",format='png')
